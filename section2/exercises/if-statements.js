...
console.log("Yay, I have enough money for a gumball");
} else if (numQuarters >= 4) {
console.log("I have enough money for more than one gumball!")
}
...
for yourself!
Yes I did! Logical operators help to narrow down a circumstance to produce the correct outcome.
